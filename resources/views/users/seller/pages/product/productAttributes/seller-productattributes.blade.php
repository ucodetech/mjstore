                ...
                <div class="col-md-6">
                  <div class="card m-md-auto">
                      ...
                      <div class="card-body">
                          ...
                          <hr>
                          <form action="{{ route('seller.vendor.attributes.add') }}" method="POST" 
                           id="addAttributeForm">
                           @csrf
                           @method('POST')
                                      ...
                                      @if(count($attributes)>0)
                                        @foreach ($attributes as $key=>$attribute)
                                            <tr>
                                              ...
                                              <td width="20%">
                                                <a href="javascript:0" data-url="{{ route('seller.vendor.attributes.edit') }}" class="edit_offer_price" data-id="{{ $attribute->id }}">
                                              ...
                                              <td width="20%">
                                                <a href="javascript:0" data-url="{{ route('seller.vendor.attributes.edit') }}" class="edit_stock" data-id="{{ $attribute->id }}" data-product_id="{{ $attribute->product_id }}">
                                              ...
                                              <td>
                                                <div class="btn-group">
                                                   ...
                                                   data-url="{{ route('seller.vendor.attributes.delete') }}"
