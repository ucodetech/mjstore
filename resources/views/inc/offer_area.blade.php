            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="beach_offer_area mb-4 mb-md-0">
                        <img src="{{ asset('assets_front/img/product-img/beach.png')}}" alt="beach-offer">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="apparels_offer_area">
                        <img src="{{ asset('assets_front/img/product-img/apparels.jpg')}}" alt="Beach-Offer">
                    ...
                    <div class="weekly_deals_area mt-30">
                        <img src="{{ asset('assets_front/img/product-img/weekly-offer.jpg')}}" alt="weekly-deals">
                        <div class="weekly_deals_info">
                            <h4>Deals of the Week</h4>
                            <div class="deals_timer">
                                <ul data-countdown="2023/10/1 14:21:38">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-12">
                            ...
                            <div class="elect_offer_area mt-30 mt-lg-0">
                                <img src="{{ asset('assets_front/img/product-img/elect.jpg')}}" alt="Elect-Offer">
                        ...
                        <div class="col-12 col-sm-6 col-lg-12">
                            ...
                            <div class="backpack_offer_area mt-30">
                                <img src="{{ asset('assets_front/img/product-img/backpack.jpg')}}" alt="Backpack-Offer">
