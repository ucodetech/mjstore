          ...
          <!-- Info boxes -->
            {{-- <div class="card" style="background-color:#060913c0;">
                ...
                <div class="card-tools">
                    <a href="{{ route('seller.vendor.orders') }}" class="btn btn-tool btn-outline-info btn-sm">
                        Back to Order
                    </a>
        ...
        <div class="card-body" id="orderItems{{$item->id }}" >
            <div class="row mb-4">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{ route('seller.vendor.orders') }}" class="btn  btn-outline-info btn-sm">
                        Back to Order
                    </a>
                </div>
            </div>
                               ...
                               <hr>
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="updateOrderStatus" id="updateOrderStatus" data-url="{{ route('seller.vendor.update.order.status') }}" data-order-id="{{ $orderid }}">
...
@section('scripts')
  <script>
    ...
    function orderStatus(orderId){
        let url = "{{ route('seller.vendor.get.order.status') }}";
