            ...
            <div class="input-group mb-3">
              ...
              <div class="form-group">
                <select name="portfolio" id="portfolio" class="form-control">
                    <option value="" class="text-secondary">Select Portfolio</option>
                    @php
                        $portf = ['Software Developer', 'Web Developer', 'Graphic Designer', 'UI/UX', 'Database Administrator'];
                    @endphp
                     @foreach ($portf as $folio)
