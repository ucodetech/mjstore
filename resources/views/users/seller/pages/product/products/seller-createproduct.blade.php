          ...
          <!-- Info boxes -->
               <div class="card">
                ...
                <div class="card-body table-responsive">
                   ...
                   <form action="{{ route('seller.vendor.process.product.create') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
...
@section('scripts')
  <script>
    ...
    FilePond.setOptions({
        server:{
            process: "{{ route('seller.tmp.product.upload') }}",
            revert: "{{ route('seller.tmp.product.delete') }}",
            headers: {
