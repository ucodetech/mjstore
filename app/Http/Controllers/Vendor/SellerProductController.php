...
class SellerProductController extends Controller
{
    public function productPage()
    {
        ...
        return view('users.seller.pages.product.products.seller-products', ['products' => $products, 'product_count' => $product_count, 'conditions' => $conditions]);
    }
    public function productAddPage()
    {
        ...
        $sizes = Size::all();
        $conditions = Condition::all();
        return view('users.seller.pages.product.products.seller-createproduct',
            [
    ...
    public function processProductCreate(Request $request)
    {
        ...
        if (!$validator->passes()) {
            ...
            if ($tmp_file) {
                ...
                return redirect()->route('seller.vendor.products.page')->with('success', 'Product added successfully!')->withInput();
            }
        }
    }
    ...
    public function processProductCreateMoreImages(Request $request)
    {
        ...
        return redirect()->route('seller.vendor.products.page')->with('success', 'Product image added successfully!')->withInput();
        // return response()->json(['code'=>1, 'msg'=>"Product image added successfully!"]);
    }
    ...
    {
        $categories = ProductCategory::where(['is_parent'=> 1, 'vendor_id'=>seller()->id])->where('status', 'active')->get();
        $brands = Brand::where('status', 'active')->get();
        $product_count = Product::where('vendor_id', seller()->id)->count();
        $product = Product::where('unique_key', $unique_key)->get()->first();
        $conditions = Condition::all();
        return view(
            'users.superuser.product.products.seller-editproducts',
            [
                'categories' => $categories,
                'brands' => $brands,
                'product_count' => $product_count,
    ...
    public function updateProduct(Request $request)
    {
        ...
        if (!$validator->passes()) {
            ...
            return redirect()->route('seller.vendor.products.page')->with('success', 'Product updated successfully!')->withInput();
        }
    }
    ...
    public function sizesPage()
    {
        ...
        return view('users.seller.pages.product.sizes.seller-sizes');
    }
    ...
    {
        $sizes = Size::where('vendor_id', seller()->id)->orderBy('id', 'desc')->get();
    ...
    {
        // $product_count = Product::where('home_shop', 1)->count();
        return view('users.seller.pages.product.colors.seller-colors');
    }
    ...
    {
        $colors = Color::where('vender_id', seller()->id)->orderBy('id', 'desc')->get();
    ...
    {
        // $product_count = Product::where('home_shop', 1)->count();
        return view('users.seller.pages.product.conditions.seller-conditions');
    }
    ...
    public function productAttributePage($uniquekey)
    {
        ...
        return view('users.seller.pages.product.productAttributes.seller-productattributes', ['uniquekey' => $uniquekey, 'attributes' => $attributes, 'product'=>$product]);
    }
    ...
    public function productInformationPage($uniquekey)
    {
        ...
        return view('users.seller.pages.product.additionalInformation.seller-productinformation', ['uniquekey' => $uniquekey, 'information' => $information, 'product'=>$product]);
    }
