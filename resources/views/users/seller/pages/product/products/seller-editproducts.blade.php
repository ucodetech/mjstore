          ...
          <!-- Info boxes -->
               <div class="card">
                ...
                <div class="card-body table-responsive">
                   ...
                   <form action="{{ route('seller.vendor.update.product') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                @foreach ($photos as $photo)
                    ...
                    <hr class="invisible">
                    <form action="{{ route('seller.vendor.delete.product.image') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
        ...
        function getchildCategory(selected){
            if(typeof selected === 'undefined'){
               let selected = '';
                ...
                let url = "{{ route('seller.get.product.child.cat') }}";
