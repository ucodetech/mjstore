        ...
        <div class="row">
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div aria-expanded="false" id="collapse_five" class="panel-collapse collapse" role="tabpanel" aria-labelledby="five">
                                    <div class="panel-body">
                                        <div class="custom-control custom-checkbox">
                                            <input type="radio" class="custom-control-input" id="cashOnDelivery" value="cash on delivery">
                                            <label class="custom-control-label" for="cashOnDelivery">Cash On Delivery</label>
                                        </div>
                                        <p>Please make sure your payment is ready, so as to not cause a delay when the delivery man arrives!</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="checkout_pagination d-flex justify-content-end mt-30">
                    {{-- <a href="{{ route('shop.comfirm.order') }}"  id="comfirmOrderBtn" class="btn btn-primary mt-2 ml-2">Comfirm Order</a> --}}
                    <form action="{{ route('shop.comfirm.order') }}" method="POST">
                        @csrf
                        @method('POST')
                        <button type="submit" class="btn btn-primary mt-2 ml-2">Comfirm Order</button>
                    </form>
                </div>
            </div>
        </div>
