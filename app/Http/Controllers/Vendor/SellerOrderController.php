...
class SellerOrderController extends Controller
{
    ...
    {
        $orders = Order::where('vendor_id', seller()->id)->orderBy('id', 'desc')->get();
        $order_count = Order::where('vendor_id', seller()->id)->count();
        return view('users.seller.pages.order.seller-orders', ['orders' => $orders, 'order_count' => $order_count]);
    }
    ...
    public function orderItems($OrderId)
    {
        ...
        return view(
            'users.seller.pages.order.seller-orderDetails',
