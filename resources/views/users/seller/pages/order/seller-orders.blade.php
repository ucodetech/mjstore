            ...
            <div class="card">
                ...
                <div class="card-tools">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-condensed table-hover" id="orderTables">
                            <thead>
                                <th>#</th>
                                <th>Order ID</th>
                                <th>User</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('seller.vendor.order.items', $order->order_number ) }}" style="cursor:pointer">
                                   ...
                                   <td>
                                   <div class="btn-group">
                                    <a href="{{ route('seller.vendor.order.items', $order->order_number ) }}" class="btn btn-outline-info btn-sm"><i class="fa fa-eye"></i></a> &nbsp;
                                    
                                    @if ($order->order_status == "pending")
                                      <button data-id="{{ $order->id }}" data-url="{{ route('seller.vendor.delete.order') }}" id="deleteOrderBtn" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i></button>
                                    @endif
...
@section('scripts')
  <script>
    ...
    $(function(){
      ...
      }).buttons().container().appendTo('#orderTables_wrapper .col-md-6:eq(0)');
