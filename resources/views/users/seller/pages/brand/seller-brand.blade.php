                ...
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('seller.vendor.add.brand') }}" method="POST" enctype="multipart/form-data"
                             id="addBrandForm">
                             @csrf
                             @method('POST')
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label for="brand_category_id">Category: 
                                        ...
                                        class="form-control select2 select2-blue w-100" placeholder="---Select Category---" multiple>
                                        <option value=""></option>
